...
values (1, 'Dog Toy'),
       ...
       (4, 'Cat Food'),
       (5, 'Fish Toy'),
       (6, 'Fish Food') on conflict do nothing;

insert into petstoreproductservice_db.public.tag (id, name)
values (1, 'small'),
       (2, 'large') on conflict do nothing;
...
values (1, 'Ball', 1, 'https://raw.githubusercontent.com/chtrembl/staticcontent/master/dog-toys/ball.jpg?raw=true', 'available'),
       ...
       (11, 'All Sizes Fish Food', 6, 'https://raw.githubusercontent.com/chtrembl/staticcontent/master/fish-food/fish.jpg?raw=true', 'available') on conflict do nothing;
...
values (1, 1), (1, 2),
       ...
       (9, 1), (9, 2),
       (10, 1), (10, 2),
       (11, 1), (11, 2) on conflict do nothing;
