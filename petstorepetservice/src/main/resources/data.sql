...
values (1, 'doggie'),
       ...
       (3, 'small'),
       (4, 'kittie'),
       (5, 'fishy') on conflict do nothing;
...
values (1, 'Afador', 1, 'https://raw.githubusercontent.com/chtrembl/staticcontent/master/dog-breeds/afador.jpg?raw=true', 'available'),
       ...
       (31, 'Goldfish', 3, 'https://raw.githubusercontent.com/chtrembl/staticcontent/master/fish-breeds/goldfish.jpg?raw=true', 'available') on conflict do nothing;
